...
locals {
  alerts = [
    ...
    { env = "dev", cluster = "dev-main-aks-01-we", namespace = "velero" },
    { env = "dev", cluster = "dev-main-aks-01-we", namespace = "webteam" },
    { env = "dev", cluster = "dev-main-aks-01-we", namespace = "wiz" },
    { env = "dev", cluster = "dev-main-aks-01-we", namespace = "hello" },
